...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vw1ouie.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vw1ouie.containers.anotherwebservice.com/
...
```
git clone git@github.com:wd2staff/container-vw1ouie.git
cd container-vw1ouie
```
...
```
docker attach container-vw1ouie
```
